...
wget https://github.com/OctoPrint/OctoPrint/archive/refs/tags/1.0.0.zip -P /root
unzip /root/1.0.0.zip -d /root
cd /root/OctoPrint-1.0.0
python /root/OctoPrint-1.0.0/setup.py install 
